...
public final class DBQueryUtil {
     ...
     */
    public static boolean dbExist(String mainTable, String driver, String url, String user, String pass) {
    ...
    private static boolean dbCheckMetadata(String mainTable) {
        ...
        try {
            ...
            DBConnection.getInstance().setRs(metaData.getTables(DBConnection.getInstance().getCon().getCatalog(), "APP",
